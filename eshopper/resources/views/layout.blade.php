...
<head>
    ...
    <link href="{{asset('public/assets/css/price-range.css')}}"  rel="stylesheet">
    ...
    <![endif]-->       
    <link rel="shortcut icon" href="{{asset('public/assets/images/ico/favicon.ico')}}">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset('public/assets/images/ico/apple-touch-icon-144-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{asset('public/assets/images/ico/apple-touch-icon-114-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{asset('public/assets/images/ico/apple-touch-icon-72-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{asset('public/assets/images/ico/apple-touch-icon-57-precomposed.png')}}">
</head><!--/head-->
...
.paymentWrap .paymentBtnGroup .paymentMethod .method.anex{
	background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPjRK7Vc-PZKKujjONMdz4U4i3phqVRIs-sruy9ktsUsiMk85e");
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{asset('public/assets/images/home/logo.png')}}" alt="" /></a>
						</div>
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{URL::to('/category-by-product/'.$category->category_id)}}">{{$category->category_name}}</a></h4>
								</div>
							</div>
							@endforeach
							</div>
						...
						<?php 
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="{{URL::to('/manufacture-by-product/'.$manufacture->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$manufacture->manufacture_name}}</a></li>
									@endforeach
								</ul>
						...
						<div class="shipping text-center"><!--shipping-->
							<img src="{{asset('public/assets/images/home/shipping.jpg')}}" alt="" />
						</div><!--/shipping-->
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-7">
							...
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('public/assets/images/home/iframe1.png')}}" alt="" />
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('public/assets/images/home/iframe2.png')}}" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('public/assets/images/home/iframe3.png')}}" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('public/assets/images/home/iframe4.png')}}" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
					...
					<div class="col-sm-3">
						<div class="address">
							<img src="{{asset('public/assets/images/home/map.png')}}" alt="" />
