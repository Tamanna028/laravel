				...
				<div class="box span12">
					...
					<td class="center">
								@if($manufacture->publication_status==1)
									...
									<a class="btn btn-danger" href="{{URL::to('/unpublish-manufacture/'.$manufacture->manufacture_id)}}">
										<i class="halflings-icon white thumbs-down"></i>  
									</a>
									@else
					<a class="btn btn-success" href="{{URL::to('/publish-manufacture/'.$manufacture->manufacture_id)}}">
