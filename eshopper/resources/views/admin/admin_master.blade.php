...
<body>
              ...
              <ul class="dropdown-menu messages">
                <li class="dropdown-menu-title">
                  ...
                  <a href="#refresh"><i class="icon-repeat"></i></a>
                              ...
                              <li>
                                    <a href="#">
                    <span class="avatar"><img src="{{asset('public/admin_assets/img/avatar.jpg')}}" alt="Avatar"></span>
                    <span class="header">
                      <span class="from">
                          Dennis Ji
                         </span>
      ...
      <div id="sidebar-left" class="span2">
        <div class="nav-collapse sidebar-nav">
          <ul class="nav nav-tabs nav-stacked main-menu">
            <li><a href="{{URL::to('/show-dashboard')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li> 
            <li>
 ...
 <li>
              ...
              <ul>
                <li><a class="submenu" href="{{URL::to('/all-manufacture')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Brand </span></a></li>
                <li><a class="submenu" href="{{URL::to('/add-manufacture')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Brand</span></a></li>
 ...
 <li>
           ...
           <li>
            ...
            <li><a href="{{URL::to('/manage-order')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Order</span></a></li>
            <li><a href="ui.html"><i class="icon-eye-open"></i><span class="hidden-tablet"> Shop Name</span></a></li>
            <li><a href="widgets.html"><i class="icon-dashboard"></i><span class="hidden-tablet"> Delivery Man</span></a></li>
