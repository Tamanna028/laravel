				  ...
				  {!! Form::open(['url' => '/dashboard', 'method' => 'post']) !!}
						...
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="admin_name"  type="hidden" placeholder="type email"/>
								<input class="input-large span10" name="admin_id"  type="hidden" placeholder="type email"/>
							</div>
